...
<head>
  ...
  <link rel="shortcut icon" href="event/assets/images/logo4.png" type="image/x-icon">
  <meta name="description" content="">
  <title>Home</title>
  <link rel="stylesheet" href="event/assets/web/assets/mobirise-icons-bold/mobirise-icons-bold.css">
  <link rel="stylesheet" href="event/assets/web/assets/mobirise-icons/mobirise-icons.css">
  <link rel="stylesheet" href="event/assets/tether/tether.min.css">
  <link rel="stylesheet" href="event/assets/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" href="event/assets/bootstrap/css/bootstrap-grid.min.css">
  <link rel="stylesheet" href="event/assets/bootstrap/css/bootstrap-reboot.min.css">
  <link rel="stylesheet" href="event/assets/socicon/css/styles.css">
  <link rel="stylesheet" href="event/assets/theme/css/style.css">
  <link rel="stylesheet" href="event/assets/mobirise/css/mbr-additional.css" type="text/css">
  
  
  
</head>
<body>
<section class="header1 cid-qx4tN47ZFV mbr-fullscreen mbr-parallax-background" id="header1-0" data-rv-view="296">

    

    <div class="mbr-overlay" style="opacity: 0.7; background-color: rgb(218, 248, 255);">
    </div>

    <div class="container">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title align-center mbr-bold pb-3 mbr-fonts-style display-1">Event Template</h1>
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-2">City festival</h3>
...
<section class="engine"><a href="https://mobirise.co/m">bootstrap table</a></section><section class="features1 cid-qx4ya5iRTC" id="features1-1" data-rv-view="299">
    ...
    <div class="container">
        <div class="media-container-row">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-img pb-3">
                    <span class="mbr-iconfont mbrib-music" style="color: rgb(35, 35, 35);" media-simple="true"></span>
                </div>
                <div class="card-box">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-img pb-3">
                    <span class="mbr-iconfont mbrib-globe" style="color: rgb(35, 35, 35);" media-simple="true"></span>
                </div>
                <div class="card-box">
...
<section class="header1 cid-qx4Dkaff8Z mbr-parallax-background" id="header1-b" data-rv-view="304">

    

    <div class="mbr-overlay" style="opacity: 0.6; background-color: rgb(119, 0, 194);">
    </div>
...
<section class="features2 cid-qx4JzuRhpj" id="features2-e" data-rv-view="307">
        ...
        <div class="media-container-row">
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="event/event/assets/images/mbr-4-1620x1080.jpg" alt="Mobirise" title="" media-simple="true">
                    </div>
                    <div class="card-box">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="event/assets/images/mbr-5-1620x1080.jpg" alt="Mobirise" title="" media-simple="true">
                    </div>
                    <div class="card-box ">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper">
                    <div class="card-img">
                        <img src="event/assets/images/mbr-6-1620x1080.jpg" alt="Mobirise" title="" media-simple="true">
                    </div>
                    <div class="card-box">
...
<section class="clients cid-qx4ykgevUu mbr-parallax-background" id="clients-3" data-rv-view="310">
        ...
        <div class="carousel slide" data-ride="carousel" role="listbox">
            ...
            <div class="carousel-item ">
                    <div class="media-container-row">
                        <div class="col-md-12">
                            <div class="wrap-img ">
                                <img src="event/assets/images/1.png" class="img-responsive clients-img" media-simple="true">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="media-container-row">
                        <div class="col-md-12">
                            <div class="wrap-img ">
                                <img src="event/assets/images/2.png" class="img-responsive clients-img" media-simple="true">
                            </div>
                        </div>
                    </div>
                </div><div class="carousel-item ">
                    <div class="media-container-row">
                        <div class="col-md-12">
                            <div class="wrap-img ">
                                <img src="event/assets/images/3.png" class="img-responsive clients-img" media-simple="true">
                            </div>
                        </div>
                    </div>
                </div><div class="carousel-item ">
...
<section class="features11 cid-qx4AOS2Cfa" id="features11-a" data-rv-view="331">
                    ...
                    <div class="block-content">
                        <div class="card p-3 pr-3">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="card-title mbr-fonts-style display-7"><strong>Burger Futurist</strong></h4>
                                </div>
                            </div>                
                        ...
                        <div class="card p-3 pr-3">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <h4 class="card-title mbr-fonts-style display-7"><strong>Cacao Food</strong></h4>
                                </div>
                            </div>                
...
<section class="mbr-section form1 cid-qx4ygxknCL mbr-parallax-background" id="form1-2" data-rv-view="334">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                    ...
                    <form class="mbr-form" action="https://mobirise.com/" method="post" data-form-title="Mobirise Form"><input type="hidden" data-form-email="true" value="wjxBslID9XRhPXMSme9vrWi/jTBTZGnZlWnFasNiEfl0EGkkWdRN5BbX/eHencbVUKWtc+06T0TZqu8ZNK1cp5F8/zKhQKjjSN/YXcuoWAZ6jYtWPgm7QeUaT0yON9XU">
...
<section class="cid-qx4yK1AHfP" id="social-buttons1-7" data-rv-view="337">
...
<section once="" class="cid-qx4yIyBn0A" id="footer7-6" data-rv-view="340">
  ...
  <script src="event/assets/web/assets/jquery/jquery.min.js"></script>
  <script src="event/assets/popper/popper.min.js"></script>
  <script src="event/assets/tether/tether.min.js"></script>
  <script src="event/assets/bootstrap/js/bootstrap.min.js"></script>
  <script src="event/assets/bootstrap-carousel-swipe/bootstrap-carousel-swipe.js"></script>
  <script src="event/assets/social-likes/social-likes.js"></script>
  <script src="event/assets/smooth-scroll/smooth-scroll.js"></script>
